...
import com.graymatterworks.gurug.ui.CreditCardEditText;
            ...
            if (result) {
                try {
                    ...
                    if (from.equals(Constant.WALLET)) {
                        ...
                        new PaymentActivity().PlaceOrder(activity, getString(R.string.paystack), reference, status.equalsIgnoreCase("success"), sendParams, status);
                    }
